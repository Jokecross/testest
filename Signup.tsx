      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8">
          ...
          <button
            ...
            className="mt-6 w-full flex items-center justify-center gap-3 border border-gray-200 rounded-lg py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors"
          >
          ...
          <p className="text-xs text-gray-400 text-center mt-4 leading-relaxed">
            ...
            <a href="#" className="text-indigo-600 hover:underline">CGV</a> et notre{' '}
